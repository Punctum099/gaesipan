...
<body>
	...
	<table width="640" cellpadding="0" cellspacing="0" border="1">
		<form id="frm" action="modify.do" method="post">
			...
			<tr>
				<td> 내용 </td>
				<td> <textarea id="contents" rows="10" name="contents" >${content_view.contents}</textarea></td>
			</tr>
			<tr >
				<td colspan="2"> <input type="button" id="input" value="수정"> &nbsp;&nbsp; <a href="list.do">목록보기</a> &nbsp;&nbsp; <a href="delete.do?seq=${content_view.seq}">삭제</a></td>
			</tr>
		</form>
	</table>
